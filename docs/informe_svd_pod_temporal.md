...
3. [Resultados y análisis de figuras](#resultados-y-analisis-de-figuras)
   1. [Figura 1 – Serie temporal diaria de accidentes](#figura-1-serie-temporal-diaria-de-accidentes)

   2. [Figura 2 – Espectro de valores singulares (SVD)](#figura-2-espectro-de-valores-singulares-svd)
   3. [Figura 3 – Energía acumulada de los modos SVD](#figura-3-energia-acumulada-de-los-modos-svd)
   4. [Figura 4 – Primeros modos “espaciales” (patrones intra-ventana)](#figura-4-primeros-modos-espaciales-patrones-intra-ventana)
   5. [Figura 5 – Primeros coeficientes temporales](#figura-5-primeros-coeficientes-temporales)
   6. [Figura 6 – Error global de reconstrucción vs número de modos](#figura-6-error-global-de-reconstruccion-vs-numero-de-modos)
   7. [Figura 7 – Error por ventana usando k≈95% de energía](#figura-7-error-por-ventana-usando-k95-de-energia)
   8. [Figura 8 – Reconstrucción de una ventana representativa](#figura-8-reconstruccion-de-una-ventana-representativa)
   9. [Figura 9 – Reconstrucción de la ventana más anómala](#figura-9-reconstruccion-de-la-ventana-mas-anomala)
   10. [Figura 10 – Heatmap de la matriz de snapshots X](#figura-10-heatmap-de-la-matriz-de-snapshots-x)
